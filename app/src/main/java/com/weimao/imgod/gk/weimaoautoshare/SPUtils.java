...
public class SPUtils {
    ...
    public static void setString(Activity activity, String key, String value) {
        SharedPreferences sp = activity.getApplication().getSharedPreferences(FILE_NAME,
     ...
     * @return value
     */
    public static boolean getBoolean(Activity activity, String key, boolean defaultBoolean) {
        SharedPreferences sp = activity.getApplication().getSharedPreferences(FILE_NAME,
                Context.MODE_PRIVATE);
